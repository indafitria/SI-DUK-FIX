...
if (isset($_POST['submit'])) {
    ...
    if (!empty($lokasi_file)) {
        ...
        // Pindahkan file yang diunggah (jika ada)
        if ($ukuran_dokumen < 15000000) {
                ...
                <div class="card-body">
                    ...
                    <form action="edit_datadiklat.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="p-2 ml-cm">
                                <div class="card mb-3">
                                    <select class="form-select" id="aksiSelect" name="jenis_diklat">
                                        <option selected> <?php echo $jenis_diklat; ?></option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" value="<?php echo $nama_diklat; ?>" name="nama_diklat" placeholder="Masukkan Nama Diklat">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" value="<?php echo $tahun_diklat; ?>" name="tahun_diklat" placeholder="Masukkan Tahun Diklat">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control" value="<?php echo $jmlh_jam; ?>" name="jmlh_jam" placeholder="Masukkan Jumlah Jam">
                            </div>
                        </div>
                        <div class="row mb-3">
