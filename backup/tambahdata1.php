                            ...
                            <div class="d-flex flex-column mb-3">
                                ...
                                <div class="p-2 mb-4 border rounded p-3">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-select" id="inputGolongan" aria-label="Default select example" name="id_golongan">
                                                ...
                                                ?>
                                                    <option value="<?= $data['id_golongan']; ?>" <?= $selected; ?>>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="date" class="form-control" id="inputTmtGol" name="tmt_golongan">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="d-flex flex-column mb-3 ">
                                    <div class="control-group3 after-add-more3 p-2">
                                        <table id="mutasi" class="table table-bordered text-center">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><textarea type="text" name="catatan_mutasi[]" style="width: 450px; border: 1px solid #ccc;"></textarea>
                                                    </td>
...
<script>
    function tambahBaris3() {
        ...
        cell2.innerHTML = '<input type="date" name="Tmt[]" />';
        // Menambahkan elemen input (file) ke dalam sel keempat
        cell3.innerHTML = '<input type="file" name="dokumen_mutasi[]" accept=".pdf" />';

        // Menambahkan tombol "Remove" ke dalam sel kelima
        cell4.innerHTML = '<button class="btn btn-danger btn-sm remove" type="button" onclick="hapusBaris1(this)"><i class="bi bi-x-lg"></i></button>';
    }
...
<!-- <script>
    function validateForm1() {
        ...
        var inputNIP = document.getElementById('inputNIP').value;
        var inputTempatLahir = document.getElementById('inputTempatLahir').value;
        var inputJenisKelamin = document.getElementById('inputJenisKelamin').value;
        var inputAgama = document.getElementById('inputAgama').value;
        var inputAlamat = document.getElementById('inputAlamat').value;
        var inputNoHP = document.getElementById('inputNoHP').value;
        var inputEmail = document.getElementById('inputEmail').value;
        var inputNpwp = document.getElementById('inputNpwp').value;
        var inputStatus = document.getElementById('inputStatus').value;

        if (inputNama.trim() === '' || inputNIP.trim() === '' || inputTempatLahir.trim() === '' || inputJenisKelamin.trim() === '' || inputAgama.trim() === '' || inputAlamat.trim() === '' || inputNoHP.trim() === '' || inputEmail.trim() === '' || inputNpwp.trim() === '' || inputStatus.trim() === '') {
            return false;
        } else {
            return true;
        }
...
function validateForm2() {
        var inputGolongan = document.getElementById('inputGolongan'); // Ganti dengan elemen yang sesuai
        var inputTmtGol = document.getElementById('inputTmtGol');
        var inputTempatLahir = document.getElementById('inputTempatLahir');  
        var inputJenisKelamin = document.getElementById('inputJenisKelamin');
        ...
        var inputNpwp = document.getElementById('inputNpwp'); 
        var inputStatus = document.getElementById('inputStatus');
         

        if (inputNama.value.trim() === '' || inputNIP.value.trim() === ''|| inputTempatLahir.value.trim() === '' || inputJenisKelamin.value.trim() === '' || inputAgama.value.trim() === '' || inputAlamat.value.trim() === ''|| inputNoHP.value.trim() === '' || inputEmail.value.trim() === '' || inputNpwp.value.trim() === '' || inputStatus.value.trim() === '' ) {
            return false;
        }
        return true;
    }
