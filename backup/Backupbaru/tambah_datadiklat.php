                ...
                <div class="card-body">
                    ...
                    <form action="tambah_datadiklat.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="nama_diklat" placeholder="Masukkan Nama Diklat">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="tahun_diklat" placeholder="Masukkan Tahun Diklat">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="number" class="form-control" name="jmlh_jam" placeholder="Masukkan Jumlah Jam">
                            </div>
                        </div>
