          ...
          <form role="form" action="editdatapegawai_2.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="p-2">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9">
                  <input type="number" class="form-control" value="<?php echo $npwp ?>" name="npwp" required="required" placeholder="Masukkan NPWP">
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-9">
                  <select class="form-select" aria-label="Default select example" name="status">
                    ...
                    <option value="Pegawai_Aktif">Aktif</option>
            ...
            <div class="d-flex flex-column mb-3">
              ...
              <div class="p-2">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-9">
                    <input type="date" class="form-control" value="<?php echo $tmt_gol ?>" name="tmt_golongan">
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="p-2">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-9">
                    ...
                    <input type="hidden" class="form-control" name="penempatan" id="nama_bidang_text" value="<?php echo isset($nama_bidang) ? $nama_bidang : ''; ?>" readonly>
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  <label for="#" class="col-sm-2 col-form-label">TMT</label>
                  <div class="col-sm-9">
                    <input type="date" class="form-control" value="<?php echo $tmt_jab ?>" name="tmt_jabatan">
                  </div>
                </div>
                <div class="row mb-3">
