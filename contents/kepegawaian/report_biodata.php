...
<body>
    ...
    <?php
    $nip = $_GET['nip'];
    $query = mysqli_query($koneksi, "SELECT * From riwayat_pangkat JOIN Pegawai ON riwayat_pangkat.nip = pegawai.nip JOIN data_pribadi ON pegawai.id_data_pribadi = data_pribadi.id_data_pribadi JOIN golongan ON pegawai.id_golongan = golongan.id_golongan JOIN data_bidang ON pegawai.id_bidang = data_bidang.id_bidang WHERE pegawai.nip = '$nip' AND riwayat_pangkat.jenis_sk = 'pangkat' ORDER BY riwayat_pangkat.tmt_sk DESC
    LIMIT 1");
    ...
    <center>
        <h4>BIODATA PESERTA </br>
            UJIAN TINGKAT II TAHUN 2023 </br>
    ...
    <center>
        <table class="table">
            <tbody>
                ...
                <tr class="tr">
                    <td class="th" rowspan="2">11</td>
                    <td class="th" rowspan="2">UJIAN DINAS YANG DIIKUTI </br> KET : BERI TANDA</td>
                    <td class="th"><input type="checkbox"> <input class="input" style="border: none;" type="text" placeholder="Ubah Tingkat Dinas"></td>
