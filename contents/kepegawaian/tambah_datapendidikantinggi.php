                ...
                <div class="card-body">
                    ...
                    <form action="tambah_datapendidikantinggi.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="jurusan" placeholder="Masukkan Jurusan" required pattern="[A-Za-z ]{1,50}" title="Harus Berupa Huruf Minimal Sebanyak 1 Karakter dan Maksimal 50 Karakter" oninput="this.reportValidity()">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="inputJumlahJam" class="col-sm-2 col-form-label">Konsentrasi</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="konsentrasi" placeholder="Masukkan Konsentrasi" required pattern="[A-Za-z ]{1,50}" title="Harus Berupa Huruf Minimal Sebanyak 1 Karakter dan Maksimal 50 Karakter" oninput="this.reportValidity()">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="inputNama" class="col-sm-2 col-form-label">Alumni</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="nama_kampus" placeholder="Masukkan Alumni" required pattern="[A-Za-z ]{1,50}" title="Harus Berupa Huruf Minimal Sebanyak 1 Karakter dan Maksimal 50 Karakter" oninput="this.reportValidity()">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="inputBulanTahun" class="col-sm-2 col-form-label">Tahun Lulus</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="tahun_lulus" placeholder="Masukkan Tahun Lulus" required pattern="[0-9]{4}" title="Harus Berupa Angka Sebanyak 4 Karakter" oninput="this.reportValidity()">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="file" class="form-control" name="ijazah" accept=".pdf" required>
