                                        ...
                                        <div class="p-2 mb-4 border rounded p-3">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <input type="hidden" class="form-control" value="-" name="konsetrasi[]" placeholder="Masukkan Konsentrasi">
                                ...
                                <div class="d-flex flex-column mb-3 ">
                                    <div class="control-group3 after-add-more3 p-2">
                                        <table id="mutasi" class="table table-bordered text-center">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><textarea type="text" name="catatan_mutasi[]" style="width: 550px; border: 1px solid #ccc;"></textarea>
                                                    </td>
...
<script>
    function tambahBaris1() {
        ...
        cell2.innerHTML = '<td><textarea type="text" name="nama[]" style="border: 1px solid #ccc;"></textarea></td>';
        cell3.innerHTML = '<td><input type="text" name="bulan/tahun[]" style="border: 1px solid #ccc;"/></td>';
        cell4.innerHTML = '<td><input type="text" name="jam[]" style="border: 1px solid #ccc;"/></td>';

        // Menambahkan elemen input (file) ke dalam sel keempat
        cell5.innerHTML = '<input type="file" name="file[]" accept=".pdf" />';
