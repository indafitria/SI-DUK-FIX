...
if (isset($_POST['Simpan'])) {
    ...
    if (empty($lokasi_dok_mut)) {
        $hasil = ubahDataRiwayatMutasi1($no_mtsi, $catatan, $nomor_sk, $tmt);
    } else 
    ...
    if (!empty($lokasi_dok_mut)) {
        ...
        if ($ukuran_dok > 15000000) { // 15 MB dalam bytes
            ...
            $hasil = ubahDataRiwayatMutasi($no_mtsi, $catatan, $nomor_sk, $tmt, $dok);
        }
    } else {
        $hasil = ubahDataRiwayatMutasi1($no_mtsi, $catatan, $nomor_sk, $tmt);
    }
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="edit_datamutasi.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="inputNomorSK" class="col-sm-2 col-form-label text-nowrap">Nomor SK</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" value="<?php echo $nomor_sk ?>" name="nomor_sk">
                            </div>
                        </div>

                        <div class="row mb-3">
                            <label for="inputNomorSK" class="col-sm-2 col-form-label">TMT</label>
                            <div class="col-sm-10">
                                <input type="date" class="form-control" value="<?php echo $tmt ?>" name="tmt_mutasi" required>
                            </div>
                        </div>
